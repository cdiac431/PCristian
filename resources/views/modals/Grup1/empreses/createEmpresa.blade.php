    ...
    <div  class="modal fade bannerformmodal" id="crearEmpresa"  tabindex="-1" role="dialog" aria-labelledby="bannerformmodal" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
           <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title" id="myModalLabel">Afegir nova Entitat</h4>
             </div>
             <form method="POST" action="{{route('empreses.store')}}">
             <div class="modal-body">
              @csrf
               ...
               <div class="row form-group">
                ...
                <div class="col-sm-7">
                 <input type="text" id="direccio" class="form-control" name="direccio" value="{{old('Direccio')}}" onfocus="focusFuncio(this)" onblur="treuColor(this)" required placeholder="Ingresa una direcció">
               </div>
              </div>
              <div class="row form-group">
                <div class="col-sm-5">
