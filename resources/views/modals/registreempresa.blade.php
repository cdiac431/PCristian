<!-- Registrar Persona empresa -->
<div class="modal fade" id="registreempresa">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header border-bottom-1">
				<h4 class="form-title col-11 text-center"><img src="./img/logoproiectus.png" width="30" height="30" class="d-inline-block align-center" alt="">Registre d'Entitat</h4>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<div class="modal-body">
				<div class="d-flex flex-column text-center">
					<form method="POST" action="{{route('registroempresas.store')}}">
						@csrf
                        ...
                        <p>Sou una...</p>
                        <div class="form-group inputBox my-4">
							<input type="text" class="form-control" required name="tipus" value="Entitat" readonly>
                            <i class="fas fa-school"></i>
						</div>
...
<!-- Registrar institut -->
@if(session('empresa'))
<div class="modal fade" id="registreempresafinal">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header border-bottom-1">
				<h4 class="form-title col-11 text-center"><img src="./img/logoproiectus.png" width="30" height="30" class="d-inline-block align-center" alt="">Dades de Empresa o Entitat</h4>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<div class="modal-body">
				<div class="d-flex flex-column text-center">
					<form method="POST" action="{{route('registreempresas.update', session('empresa')->id)}}" enctype="multipart/form-data">
						@csrf
                        @method('put')
						<p>Empresa/Entitat:</p>
						<div class="form-group inputBox my-4">
							<input type="text" class="form-control" value="{{session('empresa')->nom}}" required name="nom" readonly >
                            <i class="fas fa-school"></i>
                        	</div>
                        <div class="form-group inputBox my-4">
						...
						<div class="form-group inputBox my-4">
							<input style="padding-left: 8%;" type="file" name="docum_entitat" id="file" accept=".tar, .zip, application/pdf" size="10000" required>
