    <div  class="modal fade bannerformmodal" id="editProfessor" tabindex="-1" role="dialog" aria-labelledby="bannerformmodal" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-content">
               ...
               <form id ="formularieditar" method="POST" action="{{route('professors.update', $id ?? 'ideditar')}}">
               ...
               <div class="modal-body">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-7">
                    <select type="text" class="form-control" name="id_roles" id="rol_name" required>
             ...
             <div class="modal-footer">
               <input type="hidden" name = "professor_id_editar" id="id" >
