...
<div id="chat-container" class="container-fluid">
    <div class="row">
        ...
        <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="">
        ...
        <form class="publisher bt-1 border-light" action="{{ route('chat.store', $idChat) }}" method="POST">
            @csrf
    ...
    function update() {
        ...
        $.ajax({
            ...
            success: function(data){
                let scroll = $('#chat-content').scrollTop();
